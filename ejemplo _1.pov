...
light_source { <50, 90 ,15> color AmbientLight }
...
intersection {
   ...
   sphere { <-1, 0, 0>, 0.85 inverse }     // inner wall
   plane { <0, 1, -1>, 0.25 }              // top surface
   ...
   pigment {
      leopard
      color_map {
         [0.0   0.10 color Blue color Red ]
         [0.10  0.98 color Red color Green ]
...
intersection {
   ...
   pigment {
      ...
      octaves 2
      color_map {
         [0.0   0.30 color White color Orange ]
